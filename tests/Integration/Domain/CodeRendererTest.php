...
class CodeRendererTest extends TestCase {
	...
	public function testRendersSimplePhpWithoutLineNumbers(): void {
		$this->assertSame(
			...
			( new CodeRenderer( language: 'php', showLineNumbers: false, entryPoint: 'embed' ) )->render( 'print( "Hello world" );', '' )
		);
	}
	...
	public function testRendersSimpleTypescriptWithLineNumbers(): void {
		$this->assertSame(
			...
			( new CodeRenderer( language: 'typescript', showLineNumbers: true, entryPoint: 'embed' ) )->render( 'console.log( "Hello world" as string );', '' )
		);
	}
	...
	public function testRendersEscapedHtml(): void {
		$this->assertSame(
			...
			( new CodeRenderer( language: 'html', showLineNumbers: false, entryPoint: 'embed' ) )->render( '<script>alert( "HAX" );</script>', '' )
		);
	}
	...
	public function testRendersEscapedHtmlWithWrongLanguage(): void {
		$this->assertSame(
			...
			( new CodeRenderer( language: 'javascript', showLineNumbers: false, entryPoint: 'embed' ) )->render( '<script>alert( "HAX" );</script>', '' )
		);
	}
	...
	public function testRendersEscapedPartialHtml(): void {
		$this->assertSame(
			...
			( new CodeRenderer( language: 'html', showLineNumbers: false, entryPoint: 'embed' ) )->render( '</code></pre>FOO', '' )
		);
	}
